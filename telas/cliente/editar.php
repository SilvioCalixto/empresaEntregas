...
<html lang="pt-br">
  <head>
    ...
    <title>Editar Cliente - CargoTech</title>
          ...
          <div class="card bg-glass">
            <div class="card-body px-4 py-5 px-md-5">
              <form method="POST">
                ...
                <div class="row">
                <h4 class="mb-5 text-left"><strong>Editar Cliente</strong></h4>

                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" id="form3Example4" class="form-control" name="nome" value="<?= $cliente['nome'] ?>"/>
                  <label class="form-label" for="form3Example4">Nome: </label>
                </div>
  
                <!-- Password input -->
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" id="form3Example4" class="form-control" name="telefone" value="<?= $cliente['telefone'] ?>"/>
                  <label class="form-label" for="form3Example4">Telefone: </label>
    </div>

                <div data-mdb-input-init class="form-outline mb-4">
                <select name="codigoEndereco" class="form-select">
