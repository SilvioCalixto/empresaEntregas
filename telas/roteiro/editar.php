...
<html lang="pt-br">
  <head>
    ...
    <title>Editar Rota - CargoTech</title>
          ...
          <div class="card bg-glass">
            <div class="card-body px-4 py-5 px-md-5">
              <form method="POST">
                ...
                <div class="row">
                <h4 class="mb-5 text-left"><strong>Editar Rotas</strong></h4>

                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" id="form3Example4" class="form-control" name="regiao" value="<?= $roteiro['regiaoEntrega'] ?? '' ?>"/>
                  <label class="form-label" for="form3Example4">Região: </label>
                </div>
  

                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" id="form3Example4" class="form-control" name="dia" value="<?= $roteiro['diaEntrega'] ?? '' ?>"/>
                  <label class="form-label" for="form3Example4">Dia: </label>
                </div>
                <div class="form-outline mb-4">
  <select class="form-select" name="entregador" required>
    
    <option disabled>Selecione um entregador</option>
...
<div class="form-outline mb-4">
  <select class="form-select" name="veiculo" required>
    ...
    <option disabled>Selecione um veículo</option>
