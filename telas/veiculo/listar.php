...
<html lang="pt-br">
  <head>
    ...
    <title>Veículos - CargoTech</title>
...
<div class="container">
  ...
  <div class="card bg-glass shadow-5-strong p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <a href="cadastrar.php" class="btn btn-success">+ Novo Veículo</a>
    </div>
      ...
      <table class="table table-hover align-middle text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= $v['placa'] ?></td>
            <td>
              <a href="editar.php?id=<?= $v['codigo'] ?>" class="btn btn-warning btn-sm">
                ✏️
              </a>
              <a href="?acao=excluir&id=<?= $v['codigo'] ?>" 
