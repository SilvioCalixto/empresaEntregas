...
if($_SERVER["REQUEST_METHOD"] === "POST"){
  ...
  $mensagem = $inserir -> cadastrarEntregador($conexao,
                                              $nome,
                                              $cpf,
                                              $cnh);
  } else {
...
<html lang="pt-br">
  ...
  <body>
    <form method="POST">
      ...
      <div class="mb-3">
        <label for="cpf" class="form-label">Cadastro Pessoa Física: </label>
        <input type="text" class="form-control" id="cpf" name="cpf">
      </div>
      <div class="mb-3">
        <label for="cnh" class="form-label">Carteira Nacional de Habilitação: </label>
